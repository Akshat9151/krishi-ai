...
export const KRISHI_TRANSLATIONS = {
  ...
  en: {
    ...
    commodityMustard: "Mustard",
    commoditySoybean: "Soybean",
    commodityCotton: "Cotton",
    commodityRice: "Rice / Paddy",
    commodityOnion: "Onion",
    commodityPotato: "Potato",
    commodityGram: "Gram / Chana",
    commodityMaize: "Maize",
    allStates: "All States",
    filterByCrop: "Filter by Crop / Commodity",
    filterByState: "Filter by State",
    searchMandiDistrict: "Search Mandi or District",
    searchMandiPlaceholder: "e.g. Neemuch, Khanna, Lasalgaon",
    searchMandis: "Search Mandis",
    refreshRates: "Refresh Rates",
    liveApmcRates: "LIVE APMC RATES",
    loadingMandiRates: "Loading latest APMC arrivals and bid quotes...",
    noMandiQuotes: "No mandi quotes found matching the selected filters.",
    ...
    weatherCityPlaceholder: "Enter district or city name",
    popularDistricts: "Popular Districts:",
    fetchingReadings: "Fetching live atmospheric readings...",
    currentConditions: "CURRENT CONDITIONS",
    weatherUpdatedRealtime: "Updated in real time for field agricultural planning",
    temperature: "Temperature",
    humidity: "Humidity",
    rainfall: "Rainfall",
    windSpeed: "Wind Speed",
    officialAdvisory: "Official Agricultural Field Advisory",
    irrigationGuidance: "Irrigation Guidance",
    rainfallPostponeIrrigation: "Significant rainfall predicted. Postpone field irrigation and inspect drainage to avoid waterlogging.",
    dryWeatherIrrigation: "Dry weather observed. Light morning or evening furrow irrigation is advised for standing winter/monsoon crops.",
    sprayingSafetyWindow: "Spraying Safety Window",
    highWindSprayWarning: "High wind speeds detected (>15 km/h). Avoid pesticide or herbicide spraying today to prevent chemical drift.",
    calmWindSprayAdvice: "Calm wind speeds. Safe window for foliar fertilizer and pesticide application during early morning.",
    ...
    assistantWelcome: "🙏 <strong>Ram-Ram Farmer Brother!</strong> I am your Krishi Mitra. Type your crop name or tap the questions below.",
    tapToAsk: "💡 Tap to Ask:",
    ...
    profileRole: "Farmer / Farm Lead • KhetiTak Member",
  ...
  hi: {
    ...
    welcomeKrishi: "KhetiTak में आपका स्वागत है",
    loginTagline: "आपका स्मार्ट कृषि सहायक",
    joinKrishi: "KhetiTak से जुड़ें",
    ...
    newToKrishi: "KhetiTak पर नए हैं?",
  ...
  pa: {
    ...
    assistantPlaceholder: "ਇੱਥੇ ਆਪਣਾ ਸਵਾਲ ਲਿਖੋ...",
    trackOrderPlaceholder: "ਆਰਡਰ ਨੰਬਰ ਦਰਜ ਕਰੋ (ਜਿਵੇਂ: ORD12345)",
    sendBtn: "ਭੇਜੋ",
    searchBtn: "ਖੋਜੋ",
    trackBtn: "ਟ੍ਰੈਕ ਕਰੋ",
    welcomeFarmer: "ਨਮਸਤੇ ਕਿਸਾਨ ਵੀਰ!",
    welcomeDesc: "ਅੱਜ ਦਾ ਮੌਸਮ ਖੇਤ ਦੇਖਭਾਲ ਲਈ ਵਧੀਆ ਹੈ।",
    quickActions: "ਮੁੱਖ ਸੇਵਾਵਾਂ",
    soilBlack: "ਕਾਲੀ ਮਿੱਟੀ",
    soilClay: "ਚਿਕਨੀ ਮਿੱਟੀ",
    soilLoamy: "ਦੁਮਟ ਮਿੱਟੀ",
    soilRed: "ਲਾਲ ਮਿੱਟੀ",
    soilSandy: "ਰੇਤਲੀ ਮਿੱਟੀ",
    soilAlluvial: "ਕਾਂਪ ਮਿੱਟੀ",
    assistantIntro: "ਸਤ ਸ੍ਰੀ ਅਕਾਲ! ਖੇਤੀ, ਖਾਦ, ਬੀਜ ਜਾਂ ਕੀੜਿਆਂ ਬਾਰੇ ਕੋਈ ਵੀ ਸਵਾਲ ਪੁੱਛੋ",
    assistantHint: "ਪੰਜਾਬੀ, ਹਿੰਦੀ ਜਾਂ ਅੰਗਰੇਜ਼ੀ ਵਿੱਚ ਸਵਾਲ ਪੁੱਛੋ",
    assistantWelcome: "🙏 <strong>ਸਤ ਸ੍ਰੀ ਅਕਾਲ ਕਿਸਾਨ ਵੀਰ!</strong> ਮੈਂ ਤੁਹਾਡਾ ਕ੍ਰਿਸ਼ੀ ਮਿੱਤਰ ਹਾਂ। ਆਪਣੀ ਫ਼ਸਲ ਦਾ ਨਾਮ ਲਿਖੋ ਜਾਂ ਹੇਠਾਂ ਦਿੱਤੇ ਸਵਾਲਾਂ ਤੇ ਟੈਪ ਕਰੋ।",
    tapToAsk: "💡 ਤੁਰੰਤ ਪੁੱਛੋ:",
    weatherEmptyTitle: "ਮੌਸਮ ਦੇਖਣ ਲਈ ਉੱਪਰ ਆਪਣਾ ਸ਼ਹਿਰ ਖੋਜੋ",
    weatherEmptyDesc: "ਤਾਪਮਾਨ, ਨਮੀ ਅਤੇ ਖੇਤੀ ਸਲਾਹ ਜਾਣੋ",
    orderEmptyTitle: "ਆਪਣਾ ਆਰਡਰ ਟ੍ਰੈਕ ਕਰਨ ਲਈ ਆਰਡਰ ਨੰਬਰ ਦਰਜ ਕਰੋ",
    orderEmptyDesc: "ਡਿਲੀਵਰੀ ਅਤੇ ਭੁਗਤਾਨ ਦੀ ਸਥਿਤੀ ਜਾਂਚੋ",
    profileRole: "ਕਿਸਾਨ / ਫਾਰਮ ਲੀਡ • KhetiTak Member",
    profileUsername: "ਯੂਜ਼ਰਨੇਮ:",
    profileSecurity: "ਖਾਤਾ ਸੁਰੱਖਿਆ:",
    profileActiveSession: "ਸੁਰੱਖਿਅਤ ਲੌਗਇਨ",
    profileStore: "ਕ੍ਰਿਸ਼ੀ ਸਟੋਰ ਐਕਸੈਸ:",
    saveSettingsBtn: "ਸੇਵ ਕਰੋ",
    settingsDesc: "11 ਭਾਰਤੀ ਭਾਸ਼ਾਵਾਂ ਵਿੱਚ ਪੂਰੀ ਸਹਾਇਤਾ ਉਪਲਬਧ ਹੈ",
    signOutBtn: "ਲੌਗ ਆਊਟ",
  ...
  mr: {
    ...
    loadingMandiRates: "Loading latest APMC arrivals and bid quotes...",
    noMandiQuotes: "No mandi quotes found matching the selected filters.",
    fertilizerTitle: "खत कॅल्क्युलेटर",
    toolsTitle: "शेती साधने",
    ...
    assistantPlaceholder: "इथे आपला प्रश्न लिहा...",
    trackOrderPlaceholder: "ऑर्डर नंबर टाका (उदा: ORD12345)",
    sendBtn: "पाठवा",
    searchBtn: "शोधा",
    trackBtn: "ट्रॅक करा",
    welcomeFarmer: "नमस्कार शेतकरी बंधू!",
    welcomeDesc: "आजचे हवामान शेत काळजीसाठी उत्तम आहे।",
    quickActions: "मुख्य सेवा",
    soilBlack: "काळी माती",
    soilClay: "चिकणमाती",
    soilLoamy: "मृदू माती",
    soilRed: "लाल माती",
    soilSandy: "वालुकामय माती",
    soilAlluvial: "गाळाची माती",
    assistantIntro: "नमस्कार! शेती, खत, बियाणे किंवा कीटकांबद्दल कोणताही प्रश्न विचारा",
    assistantHint: "मराठी, हिंदी किंवा इंग्रजीत प्रश्न विचारा",
    assistantWelcome: "🙏 <strong>नमस्कार शेतकरी बंधू!</strong> मी आपला कृषी मित्र आहे. आपल्या पिकाचे नाव लिहा किंवा खालील प्रश्नांवर टॅप करा.",
    tapToAsk: "💡 लगेच विचारा:",
    weatherEmptyTitle: "हवामान पाहण्यासाठी वर आपले शहर शोधा",
    weatherEmptyDesc: "तापमान, आर्द्रता आणि शेती सल्ला जाणून घ्या",
    orderEmptyTitle: "ऑर्डर ट्रॅक करण्यासाठी आपला ऑर्डर नंबर टाका",
    orderEmptyDesc: "डिलिव्हरी आणि पेमेंट स्थिती तपासा",
    profileRole: "शेतकरी / फार्म लीड • KhetiTak Member",
    profileUsername: "वापरकर्ता नाव:",
    profileSecurity: "खाते सुरक्षा:",
    profileActiveSession: "सुरक्षित लॉगिन",
    profileStore: "कृषी स्टोअर प्रवेश:",
    saveSettingsBtn: "जतन करा",
    settingsDesc: "11 भारतीय भाषांमध्ये संपूर्ण सहाय्य उपलब्ध आहे",
    signOutBtn: "लॉग आउट",
  ...
  gu: {
    ...
    loadingMandiRates: "Loading latest APMC arrivals and bid quotes...",
    noMandiQuotes: "No mandi quotes found matching the selected filters.",
    fertilizerTitle: "ખાતર કેલ્ક્યુલેટર",
    toolsTitle: "ખેતી સાધનો",
    ...
    assistantPlaceholder: "અહીં તમારો પ્રશ્ન લખો...",
    trackOrderPlaceholder: "ઓર્ડર નંબર દાખલ કરો (દા.ત.: ORD12345)",
    sendBtn: "મોકલો",
    searchBtn: "શોધો",
    trackBtn: "ટ્રૅક કરો",
    welcomeFarmer: "નમસ્તે ખેડૂત ભાઈ!",
    welcomeDesc: "આજનું હવામાન ખેતરની સંભાળ માટે ઉત્તમ છે।",
    ...
    soilAlluvial: "કાંપ માટી",
    assistantIntro: "નમસ્તે! ખેતી, ખાતર, બીજ અથવા જીવજંતુ વિશે કોઈ પ્રશ્ન પૂછો",
    assistantHint: "ગુજરાતી, હિન્દી અથવા અંગ્રેજીમાં પ્રશ્ન પૂછો",
    assistantWelcome: "🙏 <strong>જય ખેડૂત ભાઈ!</strong> હું તમારો કૃષિ મિત્ર છું. તમારા પાકનું નામ લખો અથવા નીચેના પ્રશ્નો પર ટૅપ કરો.",
    tapToAsk: "💡 તુરંત પૂછો:",
    weatherEmptyTitle: "હવામાન જોવા માટે ઉપર તમારું શહેર શોધો",
    weatherEmptyDesc: "તાપમાન, ભેજ અને ખેતી સલાહ જાણો",
    orderEmptyTitle: "ઓર્ડર ટ્રૅક કરવા ઓર્ડર નંબર દાખલ કરો",
    orderEmptyDesc: "ડિલિવરી અને ચૂકવણીની સ્થિતિ તપાસો",
    profileRole: "ખેડૂત / ફાર્મ લીડ • KhetiTak Member",
    profileUsername: "વપરાશકર્તા નામ:",
    profileSecurity: "ખાતા સુરક્ષા:",
    profileActiveSession: "સુરક્ષિત લૉગઇન",
    profileStore: "કૃષિ સ્ટોર ઍક્સેસ:",
    saveSettingsBtn: "સાચવો",
    settingsDesc: "11 ભારતીય ભાષાઓમાં સંપૂર્ણ સહાય ઉપલબ્ધ છે",
    signOutBtn: "લૉગ આઉટ",
  ...
  bn: {
    ...
    loadingMandiRates: "Loading latest APMC arrivals and bid quotes...",
    noMandiQuotes: "No mandi quotes found matching the selected filters.",
    fertilizerTitle: "সার ক্যালকুলেটর",
    toolsTitle: "কৃষি সরঞ্জাম",
    ...
    trackOrderPlaceholder: "অর্ডার নম্বর দিন (যেমন: ORD12345)",
    sendBtn: "পাঠান",
    searchBtn: "খুঁজুন",
    trackBtn: "ট্র্যাক করুন",
    welcomeFarmer: "নমস্কার কৃষক ভাই!",
    welcomeDesc: "আজকের আবহাওয়া ক্ষেতের পরিচর্যার জন্য উপযুক্ত।",
    quickActions: "প্রধান সেবা",
    soilBlack: "কালো মাটি",
    soilClay: "এঁটেল মাটি",
    soilLoamy: "দোআঁশ মাটি",
    soilRed: "লাল মাটি",
    soilSandy: "বালুচর মাটি",
    soilAlluvial: "পলিমাটি",
    assistantIntro: "নমস্কার! চাষ, সার, বীজ বা পোকামাকড় সম্পর্কে যেকোনো প্রশ্ন করুন",
    assistantHint: "বাংলা, হিন্দি বা ইংরেজিতে প্রশ্ন করুন",
    assistantWelcome: "🙏 <strong>নমস্কার কৃষক ভাই!</strong> আমি আপনার কৃষি মিত্র। আপনার ফসলের নাম লিখুন বা নিচের প্রশ্নগুলোতে ট্যাপ করুন।",
    tapToAsk: "💡 এখনই জিজ্ঞেস করুন:",
    weatherEmptyTitle: "আবহাওয়া দেখতে উপরে আপনার শহর খুঁজুন",
    weatherEmptyDesc: "তাপমাত্রা, আর্দ্রতা এবং কৃষি পরামর্শ জানুন",
    orderEmptyTitle: "অর্ডার ট্র্যাক করতে অর্ডার নম্বর দিন",
    orderEmptyDesc: "ডেলিভারি এবং পেমেন্টের অবস্থা দেখুন",
    profileRole: "কৃষক / ফার্ম লিড • KhetiTak Member",
    profileUsername: "ব্যবহারকারীর নাম:",
    profileSecurity: "অ্যাকাউন্ট সুরক্ষা:",
    profileActiveSession: "সুরক্ষিত লগইন",
    profileStore: "কৃষি স্টোর অ্যাক্সেস:",
    saveSettingsBtn: "সংরক্ষণ করুন",
    settingsDesc: "11টি ভারতীয় ভাষায় সম্পূর্ণ সহায়তা উপলব্ধ",
    signOutBtn: "লগ আউট",
  ...
  ta: {
    ...
    loadingMandiRates: "Loading latest APMC arrivals and bid quotes...",
    noMandiQuotes: "No mandi quotes found matching the selected filters.",
    fertilizerTitle: "உரக் கால்குலேಟರ್",
    toolsTitle: "விவசாய கருவிகள்",
    ...
    assistantPlaceholder: "இங்கே உங்கள் கேள்வியை எழுதுங்கள்...",
    trackOrderPlaceholder: "ஆர்டர் எண் உள்ளிடுங்கள் (எ.கா.: ORD12345)",
    sendBtn: "அனுப்பு",
    searchBtn: "தேடு",
    trackBtn: "கண்காணி",
    welcomeFarmer: "வணக்கம் விவசாயி!",
    welcomeDesc: "இன்றைய வானிலை வயல் பராமரிப்பிற்கு சிறந்தது.",
    quickActions: "முக்கிய சேவைகள்",
    ...
    assistantIntro: "வணக்கம்! விவசாயம், உரம், விதை அல்லது பூச்சிகள் பற்றி எந்த கேள்வியும் கேளுங்கள்",
    assistantHint: "தமிழ், இந்தி அல்லது ஆங்கிலத்தில் கேள்வி கேளுங்கள்",
    assistantWelcome: "🙏 <strong>வணக்கம் விவசாயி!</strong> நான் உங்கள் கிருஷி மித்ரா. உங்கள் பயிர் பெயரை எழுதுங்கள் அல்லது கீழே உள்ள கேள்விகளை தட்டுங்கள்.",
    tapToAsk: "💡 உடனே கேளுங்கள்:",
    weatherEmptyTitle: "வானிலை பார்க்க மேலே உங்கள் நகரை தேடுங்கள்",
    weatherEmptyDesc: "வெப்பநிலை, ஈரப்பதம் மற்றும் விவசாய ஆலோசனை அறிந்து கொள்ளுங்கள்",
    orderEmptyTitle: "ஆர்டர் கண்காணிக்க ஆர்டர் எண் உள்ளிடுங்கள்",
    orderEmptyDesc: "டெலிவரி மற்றும் கட்டண நிலையை சரிபாருங்கள்",
    profileRole: "விவசாயி / பண்ணை தலைவர் • KhetiTak Member",
    profileUsername: "பயனர்பெயர்:",
    profileSecurity: "கணக்கு பாதுகாப்பு:",
    profileActiveSession: "பாதுகாப்பான உள்நுழைவு",
    profileStore: "கிருஷி ஸ்டோர் அணுகல்:",
    saveSettingsBtn: "சேமி",
    settingsDesc: "11 இந்திய மொழிகளில் முழு ஆதரவு கிடைக்கிறது",
    signOutBtn: "வெளியேறு",
  ...
  te: {
    ...
    loadingMandiRates: "Loading latest APMC arrivals and bid quotes...",
    noMandiQuotes: "No mandi quotes found matching the selected filters.",
    fertilizerTitle: "ఎరువుల గణన",
    toolsTitle: "వ్యవసాయ పరికరాలు",
    ...
    assistantPlaceholder: "ఇక్కడ మీ ప్రశ్న రాయండి...",
    trackOrderPlaceholder: "ఆర్డర్ నంబర్ నమోదు చేయండి (ఉదా: ORD12345)",
    sendBtn: "పంపు",
    searchBtn: "వెతుకు",
    trackBtn: "ట్రాక్ చేయి",
    welcomeFarmer: "నమస్కారం రైతు అన్నా!",
    welcomeDesc: "ఈ రోజు వాతావరణం పొలం సంరక్షణకు అనుకూలంగా ఉంది.",
    quickActions: "ముఖ్య సేవలు",
    soilBlack: "నల్ల మట్టి",
    soilClay: "బంకమట్టి",
    soilLoamy: "మిశ్రమ మట్టి",
    soilRed: "ఎర్ర మట్టి",
    soilSandy: "ఇసుక మట్టి",
    soilAlluvial: "గోర్వ మట్టి",
    assistantIntro: "నమస్కారం! వ్యవసాయం, ఎరువు, విత్తనాలు లేదా పురుగుల గురించి ఏ ప్రశ్నైనా అడగండి",
    assistantHint: "తెలుగు, హిందీ లేదా ఆంగ్లంలో ప్రశ్న అడగండి",
    assistantWelcome: "🙏 <strong>నమస్కారం రైతు అన్నా!</strong> నేను మీ కృషి మిత్ర. మీ పంట పేరు రాయండి లేదా దిగువ ప్రశ్నలపై నొక్కండి.",
    tapToAsk: "💡 వెంటనే అడగండి:",
    weatherEmptyTitle: "వాతావరణం చూడటానికి పైన మీ నగరాన్ని వెతకండి",
    weatherEmptyDesc: "ఉష్ణోగ్రత, తేమ మరియు వ్యవసాయ సలహా తెలుసుకోండి",
    orderEmptyTitle: "ఆర్డర్ ట్రాక్ చేయడానికి ఆర్డర్ నంబర్ నమోదు చేయండి",
    orderEmptyDesc: "డెలివరీ మరియు చెల్లింపు స్థితి తనిఖీ చేయండి",
    profileRole: "రైతు / ఫార్మ్ లీడ్ • KhetiTak Member",
    profileUsername: "వినియోగదారు పేరు:",
    profileSecurity: "ఖాతా భద్రత:",
    profileActiveSession: "సురక్షిత లాగిన్",
    profileStore: "కృషి స్టోర్ యాక్సెస్:",
    saveSettingsBtn: "సేవ్ చేయి",
    settingsDesc: "11 భారతీయ భాషలలో పూర్తి మద్దతు అందుబాటులో ఉంది",
  ...
  kn: {
    ...
    loadingMandiRates: "Loading latest APMC arrivals and bid quotes...",
    noMandiQuotes: "No mandi quotes found matching the selected filters.",
    fertilizerTitle: "ಗೊಬ್ಬರ ಕ್ಯಾಲ್ಕುಲೇಟರ್",
    toolsTitle: "ಕೃಷಿ ಉಪಕರಣಗಳು",
    ...
    assistantPlaceholder: "ಇಲ್ಲಿ ನಿಮ್ಮ ಪ್ರಶ್ನೆ ಬರೆಯಿರಿ...",
    trackOrderPlaceholder: "ಆರ್ಡರ್ ನಂಬರ್ ನಮೂದಿಸಿ (ಉದಾ: ORD12345)",
    sendBtn: "ಕಳುಹಿಸು",
    searchBtn: "ಹುಡುಕು",
    trackBtn: "ಟ್ರ್ಯಾಕ್ ಮಾಡು",
    welcomeFarmer: "ನಮಸ್ಕಾರ ರೈತ ಅಣ್ಣ!",
    welcomeDesc: "ಇಂದಿನ ಹವಾಮಾನ ಹೊಲ ನಿರ್ವಹಣೆಗೆ ಉತ್ತಮವಾಗಿದೆ.",
    quickActions: "ಮುಖ್ಯ ಸೇವೆಗಳು",
    soilBlack: "ಕಪ್ಪು ಮಣ್ಣು",
    soilClay: "ಜೇಡಿ ಮಣ್ಣು",
    soilLoamy: "ಮಿಶ್ರ ಮಣ್ಣು",
    soilRed: "ಕೆಂಪು ಮಣ್ಣು",
    soilSandy: "ಮರಳು ಮಣ್ಣು",
    soilAlluvial: "ಮೆಕ್ಕಲು ಮಣ್ಣು",
    assistantIntro: "ನಮಸ್ಕಾರ! ಕೃಷಿ, ಗೊಬ್ಬರ, ಬೀಜ ಅಥವಾ ಕೀಟಗಳ ಬಗ್ಗೆ ಯಾವುದೇ ಪ್ರಶ್ನೆ ಕೇಳಿ",
    assistantHint: "ಕನ್ನಡ, ಹಿಂದಿ ಅಥವಾ ಇಂಗ್ಲಿಷ್‌ನಲ್ಲಿ ಪ್ರಶ್ನೆ ಕೇಳಿ",
    assistantWelcome: "🙏 <strong>ನಮಸ್ಕಾರ ರೈತ ಅಣ್ಣ!</strong> ನಾನು ನಿಮ್ಮ ಕೃಷಿ ಮಿತ್ರ. ನಿಮ್ಮ ಬೆಳೆ ಹೆಸರು ಬರೆಯಿರಿ ಅಥವಾ ಕೆಳಗಿನ ಪ್ರಶ್ನೆಗಳನ್ನು ಟ್ಯಾಪ್ ಮಾಡಿ.",
    tapToAsk: "💡 ತಕ್ಷಣ ಕೇಳಿ:",
    weatherEmptyTitle: "ಹವಾಮಾನ ನೋಡಲು ಮೇಲೆ ನಿಮ್ಮ ನಗರ ಹುಡುಕಿ",
    weatherEmptyDesc: "ತಾಪಮಾನ, ತೇವಾಂಶ ಮತ್ತು ಕೃಷಿ ಸಲಹೆ ತಿಳಿಯಿರಿ",
    orderEmptyTitle: "ಆರ್ಡರ್ ಟ್ರ್ಯಾಕ್ ಮಾಡಲು ಆರ್ಡರ್ ನಂಬರ್ ನಮೂದಿಸಿ",
    orderEmptyDesc: "ಡೆಲಿವರಿ ಮತ್ತು ಪಾವತಿ ಸ್ಥಿತಿ ಪರಿಶೀಲಿಸಿ",
    profileRole: "ರೈತ / ಫಾರ್ಮ್ ಲೀಡ್ • KhetiTak Member",
    profileUsername: "ಬಳಕೆದಾರ ಹೆಸರು:",
    profileSecurity: "ಖಾತೆ ಭದ್ರತೆ:",
    profileActiveSession: "ಸುರಕ್ಷಿತ ಲಾಗಿನ್",
    profileStore: "ಕೃಷಿ ಸ್ಟೋರ್ ಪ್ರವೇಶ:",
    saveSettingsBtn: "ಉಳಿಸು",
    settingsDesc: "11 ಭಾರತೀಯ ಭಾಷೆಗಳಲ್ಲಿ ಸಂಪೂರ್ಣ ಬೆಂಬಲ ಲಭ್ಯವಿದೆ",
    signOutBtn: "ಲಾಗ್ ಔಟ್",
  ...
  ml: {
    ...
    mandiTitle: "മാർക്കറ്റ് നിരക്കുകൾ",
    allCommodities: "All Commodities",
    commodityWheat: "Wheat",
    commodityMustard: "Mustard",
    commoditySoybean: "Soybean",
    ...
    loadingMandiRates: "Loading latest APMC arrivals and bid quotes...",
    noMandiQuotes: "No mandi quotes found matching the selected filters.",
    fertilizerTitle: "വള കാൽക്കുലേറ്റർ",
    toolsTitle: "കൃഷി ഉപകരണങ്ങൾ",
    ...
    assistantPlaceholder: "ഇവിടെ നിങ്ങളുടെ ചോദ്യം ടൈപ്പ് ചെയ്യൂ...",
    trackOrderPlaceholder: "ഓർഡർ നമ്പർ നൽകൂ (ഉദാ: ORD12345)",
    sendBtn: "അയക്കൂ",
    searchBtn: "തിരയൂ",
    trackBtn: "ട്രാക്ക് ചെയ്യൂ",
    welcomeFarmer: "നമസ്കാരം കർഷക സഹോദരാ!",
    welcomeDesc: "ഇന്നത്തെ കാലാവസ്ഥ വയൽ പരിചരണത്തിന് അനുകൂലമാണ്.",
    quickActions: "പ്രധാന സേവനങ്ങൾ",
    soilBlack: "കരിമണ്ണ്",
    soilClay: "കളിമണ്ണ്",
    soilLoamy: "മിശ്രിത മണ്ണ്",
    soilRed: "ചുവന്ന മണ്ണ്",
    soilSandy: "മണൽ മണ്ണ്",
    soilAlluvial: "എക്കൽ മണ്ണ്",
    assistantIntro: "നമസ്കാരം! കൃഷി, വളം, വിത്ത് അല്ലെങ്കിൽ കീടങ്ങളെക്കുറിച്ച് ഏത് ചോദ്യവും ചോദിക്കൂ",
    assistantHint: "മലയാളം, ഹിന്ദി അല്ലെങ്കിൽ ഇംഗ്ലീഷിൽ ചോദ്യം ചോദിക്കൂ",
    assistantWelcome: "🙏 <strong>നമസ്കാരം കർഷക സഹോദരാ!</strong> ഞാൻ നിങ്ങളുടെ കൃഷി മിത്ര. നിങ്ങളുടെ വിളയുടെ പേര് ടൈപ്പ് ചെയ്യൂ അല്ലെങ്കിൽ ചുവടെയുള്ള ചോദ്യങ്ങൾ ടാപ്പ് ചെയ്യൂ.",
    tapToAsk: "💡 ഉടൻ ചോദിക്കൂ:",
    weatherEmptyTitle: "കാലാവസ്ഥ കാണാൻ മുകളിൽ നിങ്ങളുടെ നഗരം തിരയൂ",
    weatherEmptyDesc: "താപനില, ഈർപ്പം, കാർഷിക ഉപദേശം അറിയൂ",
    orderEmptyTitle: "ഓർഡർ ട്രാക്ക് ചെയ്യാൻ ഓർഡർ നമ്പർ നൽകൂ",
    orderEmptyDesc: "ഡെലിവറിയും പേമെന്റ് സ്ഥിതിയും പരിശോധിക്കൂ",
    profileRole: "കർഷകൻ / ഫാം ലീഡ് • KhetiTak Member",
    profileUsername: "ഉപയോക്തൃ നാമം:",
    profileSecurity: "അക്കൗണ്ട് സുരക്ഷ:",
    profileActiveSession: "സുരക്ഷിത ലോഗിൻ",
    profileStore: "കൃഷി സ്റ്റോർ ആക്സസ്:",
    saveSettingsBtn: "സേവ് ചെയ്യൂ",
    settingsDesc: "11 ഭാരതീയ ഭാഷകളിൽ പൂർണ്ണ പിന്തുണ ലഭ്യമാണ്",
  ...
  or: {
    ...
    loadingMandiRates: "Loading latest APMC arrivals and bid quotes...",
    noMandiQuotes: "No mandi quotes found matching the selected filters.",
    fertilizerTitle: "ଖତ କାଲକୁଲେଟର",
    toolsTitle: "କୃଷି ଉପକରଣ",
    ...
    assistantPlaceholder: "ଏଠାରେ ଆପଣଙ୍କ ପ୍ରଶ୍ନ ଲିଖନ୍ତୁ...",
    trackOrderPlaceholder: "ଅର୍ଡର ନମ୍ବର ଦିଅନ୍ତୁ (ଯଥା: ORD12345)",
    sendBtn: "ପଠାନ୍ତୁ",
    searchBtn: "ଖୋଜନ୍ତୁ",
    trackBtn: "ଟ୍ରାକ୍ କରନ୍ତୁ",
    welcomeFarmer: "ନମସ୍କାର ଚାଷୀ ଭାଇ!",
    welcomeDesc: "ଆଜିର ଆବହାୱା ଜମି ଯତ୍ନ ପାଇଁ ଉତ୍ତମ।",
    quickActions: "ମୁଖ୍ୟ ସେବା",
    soilBlack: "କଳା ମାଟି",
    soilClay: "ଚିକ୍କଣ ମାଟି",
    soilLoamy: "ଦୋ-ଆଁଶ ମାଟି",
    soilRed: "ଲାଲ ମାଟି",
    soilSandy: "ବାଲିଆ ମାଟି",
    soilAlluvial: "ଜଲୋଢ ମାଟି",
    assistantIntro: "ନମସ୍କାର! ଚାଷ, ସାର, ବିହନ ବା ପୋକ ବିଷୟରେ ଯେ କୌଣସି ପ୍ରଶ୍ନ ପଚାରନ୍ତୁ",
    assistantHint: "ଓଡ଼ିଆ, ହିନ୍ଦୀ ବା ଇଂରାଜୀରେ ପ୍ରଶ୍ନ ପଚାରନ୍ତୁ",
    assistantWelcome: "🙏 <strong>ନମସ୍କାର ଚାଷୀ ଭାଇ!</strong> ମୁଁ ଆପଣଙ୍କ କୃଷି ମିତ୍ର। ଆପଣଙ୍କ ଫସଲ ନାମ ଲିଖନ୍ତୁ ବା ନିମ୍ନ ପ୍ରଶ୍ନ ଉପରେ ଟ୍ୟାପ୍ କରନ୍ତୁ।",
    tapToAsk: "💡 ତୁରନ୍ତ ପଚାରନ୍ତୁ:",
    weatherEmptyTitle: "ଆବହାୱା ଦେଖିବା ପାଇଁ ଉପରେ ଆପଣଙ୍କ ସହର ଖୋଜନ୍ତୁ",
    weatherEmptyDesc: "ତାପମାତ୍ରା, ଆର୍ଦ୍ରତା ଓ କୃଷି ପରାମର୍ଶ ଜାଣନ୍ତୁ",
    orderEmptyTitle: "ଅର୍ଡର ଟ୍ରାକ୍ ପାଇଁ ଅର୍ଡର ନମ୍ବର ଦିଅନ୍ତୁ",
    orderEmptyDesc: "ଡେଲିଭରି ଓ ପେମେଣ୍ଟ ସ୍ଥିତି ଯାଞ୍ଚ କରନ୍ତୁ",
    profileRole: "ଚାଷୀ / ଫାର୍ମ ଲିଡ • KhetiTak Member",
    profileUsername: "ଉପଯୋଗକର୍ତ୍ତା ନାମ:",
    profileSecurity: "ଖାତା ସୁରକ୍ଷା:",
    profileActiveSession: "ସୁରକ୍ଷିତ ଲଗଇନ",
    profileStore: "କୃଷି ଷ୍ଟୋର ଆକ୍ସେସ:",
    saveSettingsBtn: "ସେଭ କରନ୍ତୁ",
    settingsDesc: "11 ଭାରତୀୟ ଭାଷାରେ ସମ୍ପୂର୍ଣ ସହାୟତା ଉପଲବ୍ଧ",
    signOutBtn: "ଲଗ ଆଉଟ",
