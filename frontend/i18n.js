...
const KRISHI_TRANSLATIONS = {
  ...
  en: {
    ...
    deliveryTime: "Delivery: 10-15 mins",
    storeSubheader: "⚡ 10-Minute Farm Delivery to your doorstep",
  ...
  hi: {
    ...
    deliveryTime: "डिलीवरी: 10-15 मिनट",
    storeSubheader: "⚡ 10 मिनट में कृषि उत्पाद सीधे आपके खेत / घर तक",
  ...
  pa: {
    ...
    deliveryTime: "ਡਿਲੀਵਰੀ: 10-15 ਮਿੰਟ",
    storeSubheader: "⚡ 10 ਮਿੰਟਾਂ ਵਿੱਚ ਖੇਤੀ ਉਤਪਾਦ ਤੁਹਾਡੇ ਖੇਤ ਤੱਕ",
  ...
  mr: {
    ...
    deliveryTime: "डिलिव्हरी: १०-१५ मिनिटे",
    storeSubheader: "⚡ १० मिनिटांत कृषी साहित्य थेट तुमच्या शेतावर",
  ...
  gu: {
    ...
    deliveryTime: "ડિલિવરી: 10-15 મિનિટ",
    storeSubheader: "⚡ 10 મિનિટમાં કૃષિ સામગ્રી સીધી તમારા ખેતરે",
  ...
  bn: {
    ...
    deliveryTime: "ডেলিভারি: ১০-১৫ মিনিট",
    storeSubheader: "⚡ ১০ মিনিটে চাষের সামগ্রী সরাসরি খামারে",
  ...
  ta: {
    ...
    deliveryTime: "டெலிவரி: 10-15 நிமிடங்கள்",
    storeSubheader: "⚡ 10 நிமிடங்களில் விவசாயப் பொருட்கள் உங்கள் தோட்டம் வரை",
  ...
  te: {
    ...
    deliveryTime: "డెలివరీ: 10-15 నిమిషాలు",
    storeSubheader: "⚡ 10 నిమిషాల్లో వ్యవసాయ వస్తువులు మీ పొలానికి",
  ...
  kn: {
    ...
    deliveryTime: "ವಿತರಣೆ: 10-15 ನಿಮಿಷಗಳು",
    storeSubheader: "⚡ 10 ನಿಮಿಷಗಳಲ್ಲಿ ಕೃಷಿ ಸಾಮಗ್ರಿಗಳು ನಿಮ್ಮ ತೋಟಕ್ಕೆ",
  ...
  ml: {
    ...
    deliveryTime: "ഡെലിവറി: 10-15 മിനിറ്റ്",
    storeSubheader: "⚡ 10 മിനിറ്റിനുള്ളിൽ കാർഷിക ഉൽപ്പന്നങ്ങൾ നിങ്ങളുടെ തോട്ടത്തിൽ",
  ...
  or: {
    ...
    deliveryTime: "ଡେଲିଭରୀ: ୧୦-୧୫ ମିନିଟ୍",
    storeSubheader: "⚡ ୧୦ ମିନିଟରେ କୃଷି ସାମଗ୍ରୀ ସିଧା ଆପଣଙ୍କ ବିଲକୁ",
